    ...
    if (self) {
        ...
        for (int y = 0; y<TOTALY; y++) {
            for (int x = 0; x<TOTALX; x++) {
                ...
                //    [drawS spawnAtX:x Y:y Width:DRAWSPRITE_WIDTH Height:DRAWSPRITE_HEIGH addWidth2:300 AddHeigh2:300];
                [drawz spawnAtX:x Y:y Width:DRAWSPRITE_WIDTH Height:DRAWSPRITE_HEIGH addWidth2:500 AddHeigh2:200];
                //   [m_drawSpriteArray addObject:drawS];
                [m_drawSpriteArray addObject:drawz];
